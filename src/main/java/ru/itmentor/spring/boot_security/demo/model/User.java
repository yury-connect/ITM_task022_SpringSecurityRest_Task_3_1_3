...
public class User {
    ...
    @ManyToMany(cascade = { CascadeType.PERSIST, CascadeType.MERGE }, fetch = FetchType.EAGER)     // FetchType.EAGER удобно, но может привести к проблемам производительности, если кол-во ролей велико или ты часто работаешь с большим количеством пользователей.
