...
INSERT INTO user_roles (user_id, role_id) VALUES
                                              ...
                                              ((SELECT user_id FROM users WHERE user_name = 'admin1'), (SELECT role_id FROM roles WHERE role_name = 'ROLE_GUEST')),
                                              ...
                                              ((SELECT user_id FROM users WHERE user_name = 'admin2'), (SELECT role_id FROM roles WHERE role_name = 'ROLE_GUEST')),
                                              ...
                                              ((SELECT user_id FROM users WHERE user_name = 'admin3'), (SELECT role_id FROM roles WHERE role_name = 'ROLE_GUEST'));
...
INSERT INTO user_roles (user_id, role_id) VALUES
                                              ...
                                              ((SELECT user_id FROM users WHERE user_name = 'superadmin1'), (SELECT role_id FROM roles WHERE role_name = 'ROLE_GUEST')),
                                              ...
                                              ((SELECT user_id FROM users WHERE user_name = 'superadmin2'), (SELECT role_id FROM roles WHERE role_name = 'ROLE_GUEST')),
                                              ...
                                              ((SELECT user_id FROM users WHERE user_name = 'superadmin3'), (SELECT role_id FROM roles WHERE role_name = 'ROLE_GUEST')),
