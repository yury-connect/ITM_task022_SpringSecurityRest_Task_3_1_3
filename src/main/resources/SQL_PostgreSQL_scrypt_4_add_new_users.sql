...
INSERT INTO user_roles (user_id, role_id) VALUES
    ((SELECT user_id FROM users WHERE user_name = 'guest'), (SELECT role_id FROM roles WHERE role_name = 'GUEST'));

-- Пользователь с ролями GUEST и USER
INSERT INTO user_roles (user_id, role_id) VALUES
                                              ((SELECT user_id FROM users WHERE user_name = 'user'), (SELECT role_id FROM roles WHERE role_name = 'GUEST')),
                                              ((SELECT user_id FROM users WHERE user_name = 'user'), (SELECT role_id FROM roles WHERE role_name = 'USER'));

-- Пользователь с ролями GUEST, USER и ADMIN
INSERT INTO user_roles (user_id, role_id) VALUES
                                              ((SELECT user_id FROM users WHERE user_name = 'admin'), (SELECT role_id FROM roles WHERE role_name = 'GUEST')),
                                              ((SELECT user_id FROM users WHERE user_name = 'admin'), (SELECT role_id FROM roles WHERE role_name = 'USER')),
                                              ((SELECT user_id FROM users WHERE user_name = 'admin'), (SELECT role_id FROM roles WHERE role_name = 'ADMIN'));

-- Пользователь с ролями GUEST, USER, ADMIN и SUPERSAMIN
INSERT INTO user_roles (user_id, role_id) VALUES
                                              ((SELECT user_id FROM users WHERE user_name = 'superadmin'), (SELECT role_id FROM roles WHERE role_name = 'GUEST')),
                                              ((SELECT user_id FROM users WHERE user_name = 'superadmin'), (SELECT role_id FROM roles WHERE role_name = 'USER')),
                                              ((SELECT user_id FROM users WHERE user_name = 'superadmin'), (SELECT role_id FROM roles WHERE role_name = 'ADMIN')),
                                              ((SELECT user_id FROM users WHERE user_name = 'superadmin'), (SELECT role_id FROM roles WHERE role_name = 'SUPERSAMIN'));
